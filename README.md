...
This is the official website for the University of Toronto Mississauga Google Developer Groups (UTM GDG). The frontend is built with [Next.js App Router](https://nextjs.org/docs/app) with Material UI installed.
