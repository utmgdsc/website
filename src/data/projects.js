export const projects = [
	...
	},
	{
		...
		description:
			'elDEARly is our solution for teaching technology to the elderly. elDEARly will provide interactive help and easy to follow guides for common tasks.',
		year: 2022,
		session: 'Fall',
	},
	{
...

	{
		...
		description:
			"A massive events platform that's able to help individuals find others with similar interests through our interactive maps.",
		year: 2022,
		session: 'Winter',
	},
	{
	...
	{
		title: 'Tail Trackr',
		url: 'https://github.com/utmgdsc/TAIL-Trackr',
		description:
	...
	{
		title: 'CarbonTrack',
		url: 'https://github.com/utmgdsc/CarbonTrack',
		description:
	...
	{
		title: 'Findify',
		url: 'https://github.com/utmgdsc/Findify',
		description: 'A web-based application to revolutionise and streamline the lost & found process at UTM.',
		year: 2023,
		session: 'Fall',
	},
	{
		title: 'SquadUp!',
		url: 'https://github.com/utmgdsc/SquadUp',
		description: 'A mobile application that promotes holistic health through community and accountability.',
		year: 2023,
		session: 'Fall',
	},
];
