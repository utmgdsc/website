...
import './index.css';
import { Container, Typography, Grid, Accordion, AccordionSummary, AccordionDetails, List, ListItem, ListItemButton, ListItemText, ListItemIcon } from "@mui/material";
...
const ResourcesPage = () => {
	...
	return (
		...
		<Container sx={{ py: 4 }} component="main" id="resources">
			...
			spacing={2}
			sx={{
				// mui negative margin for some reason
				margin: 0
			}}
			>
				<Grid md={3}>
